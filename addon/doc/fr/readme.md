...
* ajout dans les scripts de base de déplacement de paragraphe en paragraphe ("Contrôle+Flèche bas ou haut"), la possibilité configurable de sauter les paragraphes vides,
...
* amélioration de l'accessibilité du correcteur orthographique de Word 2013 et 2016 :
	...
	* le script (NVDA+contrôle+f7") pour annoncer la phrase courante sous le focus.
