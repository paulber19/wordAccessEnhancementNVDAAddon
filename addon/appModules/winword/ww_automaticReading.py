...
# same as nvda speech method, but modified to speak comment
	...
	def getControlFieldSpeech(
		...
		# same as speech method, but modified to speak endnote and footnote
		NVDAVersion = [version_year, version_major]
		if NVDAVersion >= [2024, 1]:
			funct = self.getControlFieldSpeech_2024_1
		elif NVDAVersion >= [2023, 3]:
			funct = self.getControlFieldSpeech_2023_3
		elif NVDAVersion >= [2023, 2]:
			funct = self.getControlFieldSpeech_2023_2
		else:
			funct = self.getControlFieldSpeech_2023_1
	...
	def getControlFieldSpeech_2024_1(  # noqa: C901
		self,
		attrs: textInfos.ControlField,
		ancestorAttrs: List[textInfos.Field],
		fieldType: str,
	...
	def getControlFieldSpeech_2023_3(  # noqa: C901
		self,
		attrs: textInfos.ControlField,
		ancestorAttrs: List[textInfos.Field],
		fieldType: str,
	...
	def getControlFieldSpeech_2023_2(  # noqa: C901
		self,
		attrs: textInfos.ControlField,
		ancestorAttrs: List[textInfos.Field],
		fieldType: str,
