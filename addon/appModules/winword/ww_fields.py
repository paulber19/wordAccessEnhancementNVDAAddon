...
from .ww_wdConst import wdActiveEndPageNumber , wdFirstCharacterLineNumber , wdGoToField
...
#		self.inLineShape = item.InLineShape
...
""")
		sInfo = sInfo.replace("\n", "\r\n")
		return sInfo.format(page =self.page, line= self.line)
...
class Fields(Collection):
	...
	def __init__(self, parent,obj, rangeType):
		...
		super(Fields, self).__init__( parent, obj)
