...
class AddonConfigurationManager():
	...
	def terminate(self):
		self.saveSettings()
	def toggleGeneralOption (self, id, toggle = True):
	...
	def toggleSkipEmptyParagraphsOption(self, toggle = True):
		return self.toggleGeneralOption (ID_SkipEmptyParagraphs, toggle)
	
	def togglePlaySoundOnSkippedParagraphOption(self, toggle = True):
		return self.toggleGeneralOption (ID_PlaySoundOnSkippedParagraph, toggle)
	
	def toggleUseQuickNavigationModeOption(self, toggle = True):
		return self.toggleGeneralOption( ID_UseQuickNavigationMode, toggle)
