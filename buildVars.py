...
* accessibility enhancement for spelling checker (Word 2013 and 2016):
	* a script (NNVDA+shift+f7") to report spelling or grammatical error and suggested correction by the spelling checker,
...
os.path.join("addon", "globalPlugins", "wordAccessEnhancement", "updateHandler", "*.py"),
